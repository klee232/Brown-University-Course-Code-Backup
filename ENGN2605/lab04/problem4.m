function pairs = problem4(directory,set)
% read image
...
mkdir problem_3_and_4\pair_outcome2
figure(1);
imshow(image1);
hold on
plot(f1(1,:),f1(2,:),"ro");
filename=strcat('problem_3_and_4\pair_outcome2\','f1.png');
saveas(gcf,filename);
figure(2);
imshow(image2);
hold on
plot(f2(1,:),f2(2,:),"ro");
filename=strcat('problem_3_and_4\pair_outcome2\','f2.png');
saveas(gcf,filename);
figure(3);
imshow(image2);
hold on 
